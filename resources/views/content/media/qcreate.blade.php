...
<div class="modal-dialog modal-md">
    <form action="{{ route('media.upload', $type) }}" method="POST" class="form" enctype='multipart/form-data'>
      @method('POST')
      @csrf
          ...
          <div class="col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row mb-2">
                  <div class="col-12">
                    <label>Supported file formats are {{ App\Models\Media::getTypeValidation($type) }}</label>
