              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary chooseImage modal_button_overlap mb-1" data-name="audio" data-action="{{ route('media.qcreate', 'audio') }}">Upload New</button>
                    <select class="form-control input-lg mediaLibrary " name="audio">
                        <option selected value=""></option>
                        @foreach($request->user()->audios as $media)
