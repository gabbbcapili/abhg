          ...
          <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('username') is-invalid @enderror" id="register-username"
                name="username" placeholder="johndoe" aria-describedby="register-username" tabindex="1" autofocus
                value="{{ old('username') }}" />
              @error('username')
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="register-last-name"
                name="last_name" placeholder="Doe" aria-describedby="register-last-name" tabindex="2" autofocus
                value="{{ old('last_name') }}" />
              @error('last_name')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="register-email"
                name="email" placeholder="john@example.com" aria-describedby="register-email" tabindex="3"
                value="{{ old('email') }}" />
              @error('email')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
            ...
            @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
              <div class="mb-1">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="terms" name="terms" tabindex="5" />
            ...
            @endif
            <button type="submit" class="btn btn-primary w-100" tabindex="6">Sign up</button>
          </form>
