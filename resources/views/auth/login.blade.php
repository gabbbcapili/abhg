      ...
      <div class="card mb-0">
        <div class="card-body">
          <a href="#" class="brand-logo">
            <!-- logo here -->
            <img src="{{ asset('images/logo/logo.jpg') }}" style="height:59px; width:78px">
            <h2 class="brand-text text-primary ms-1 text-center">Amazing Business Hub Global</h2>
          </a>

          <h4 class="card-title mb-1">Welcome to ABHG! 👋</h4>
